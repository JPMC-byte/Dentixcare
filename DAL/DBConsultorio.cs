...
namespace DAL
{
    public class DBConsultorio : ConexionOracle
    {
        ...
        public string guardarDato(Consultorio consultorio)
        {
        ...
        public Consultorio obtenerPorCodigo(string codigo)
        {
        ...
        private void ConsultorioCreado()
        {
            ...
            var consultorioExistente = obtenerPorCodigo(codigo);
            ...
            if (consultorioExistente == null)
            {
                ...
                string resultado = guardarDato(consultorio);
            }
        }
    }
}
