...
namespace GUI
{
    public partial class FrmLoginOrtodoncista : Form
    {
        ...
        private void FrmLoginOrtodoncista_Load(object sender, EventArgs e)
        {
        ...
        private void ingreso()
        {
            ...
            if (validarUsuario(ortodoncista)) abrirIngreso(ortodoncista);
        }
        ...
        bool validarUsuario(Ortodoncista ortodoncista)
        {
        ...
        void abrirIngreso(Ortodoncista ortodoncista)
        {
