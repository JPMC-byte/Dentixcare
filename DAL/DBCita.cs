...
namespace DAL
{
    public class DBCita : ConexionOracle
    {
        ...
        public DBCita() { }
        public string guardarDatos(Cita cita)
        {
            ...
            try
            {
                ...
                using (OracleCommand command = new OracleCommand(query, conexion))
                {
                    ...
                    command.Parameters.Add(new OracleParameter("Recordatorio_Cita", cita.RecordatorioCita.HasValue ? (cita.RecordatorioCita.Value ? '1' : '0') : (object)DBNull.Value));
        ...
        public List<Cita> obtenerTodos()
        {
            ...
            string query = "SELECT * FROM CITA ORDER BY TO_NUMBER(ID_CITA)";
