...
namespace DAL
{
    public class DBTratamiento : ConexionOracle
    {
        ...
        public string guardarDato(Tratamiento tratamiento)
        {
        ...
        public List<Tratamiento> obtenerTodos()
        {
            ...
            string query = "SELECT * FROM TRATAMIENTO ORDER BY TO_NUMBER(SUBSTR(ID_TRATAMIENTO, 2))";
        ...
        public List<Tratamiento> cargarPorCodigoDiagnostico(string codigo)
        {
            return obtenerTodos().Where(trat => trat.CodigoDiagnostico == codigo).ToList();
        }
        public List<Tratamiento> cargarPorCodigoFactura(string codigo)
        {
            return obtenerTodos().Where(trat => trat.CodigoFactura == codigo).ToList();
        }

        public Tratamiento obtenerPorCodigo(string idTratamiento)
        {
            return obtenerTodos().FirstOrDefault(t => t.ID_Tratamiento == idTratamiento);
        }

        public string eliminarDato(string idTratamiento)
        {
        ...
        public string actualizarDato(Tratamiento tratamiento)
        {
